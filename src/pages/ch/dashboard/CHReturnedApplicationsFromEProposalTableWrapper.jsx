...
const CHReturnedApplicationsFromEProposalTableWrapper = ({
  query,
  pageNumber,
  setPageNumber,
  pageSize,
    ...
    return (
      <Center py={16}>
        <VStack spacing={4}>
          ...
          <VStack>
            <Heading size="md">
              No Returned Applications (from eProposal)
            </Heading>
            <Text color="body" textAlign="center">
              It seems you haven't got any returned quarter booking applications
              from eProposal yet.
            </Text>
          </VStack>
        </VStack>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate("/ch/dashboard/details", {
                            state: { rowState: row, tab: "pending" },
                          })
                        }
                      >
                        Take Action
...
export default CHReturnedApplicationsFromEProposalTableWrapper;
