...
const SendToChairmanForm = ({ rowState, actionCode, isOpen, onClose }) => {
  // Hooks
    ...
    (error) => {
      toast({
        ...
        description:
          ...
          "Oops! something went wrong. Couldn't send the application.",
      });
      return error;
    }
  );
              ...
              return (
                <Form>
                  <ModalBody as={Stack} spacing={4}>
                    <Text>
                      Are you sure you want to send the quarter booking
                      application back to the chairman for application number{" "}
...
export default SendToChairmanForm;
