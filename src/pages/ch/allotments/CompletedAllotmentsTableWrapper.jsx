...
const CompletedAllotmentsTableWrapper = ({
  query,
  pageNumber,
  setPageNumber,
}) => {
    ...
    return (
      <Center py={16}>
        <VStack spacing={4}>
          ...
          <VStack>
            <Heading size="md">Your completed allotments is empty</Heading>
            <Text color="body" textAlign="center">
              It seems you haven't got any completed allotments yet.
            </Text>
          </VStack>
        </VStack>
      </Center>
...
export default CompletedAllotmentsTableWrapper;
