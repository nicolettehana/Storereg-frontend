...
const fetchItemsByType = (
  ...
  return axiosClient.get(
    `/items${category ? `/${category}` : ""}?page=${pageNumber}&size=${pageSize}&search=${search}`,
  );
};
...
export const useFetchItemsByType = (category, search, pageNumber, pageSize) => {
  ...
  return useQuery({
    queryKey: ["items", category, search, pageNumber, pageSize],
    queryFn: () =>
      fetchItemsByType(axiosClient, category, search, pageNumber, pageSize),
  });
};
 ...
 * ----------------------------
 */
const createItem = (axiosClient, data) => {
...
export const useCreateItem = (onSuccess, onError) => {
  ...
  return useMutation({
    mutationFn: (data) => createItem(axiosClient, data),
    onSuccess,
    onError,
  });
};
 ...
 * ----------------------------
 */
const fetchItemsList = (axiosClient, category, search = "") => {
  return axiosClient.get(
    `/items/list${category ? `/${category}` : ""}?search=${search}`,
  );
};
...
export const useFetchItemsList = (category, search) => {
  ...
  return useQuery({
    queryKey: ["items-list", category, search],
    queryFn: () => fetchItemsList(axiosClient, category, search),
  });
};
 ...
 * ----------------------------
 */
const exportItems = (axiosClient, category) => {
  return axiosClient.get(`/items/export?category=${category}`, {
    responseType: "blob",
  });
};
...
export const useExportItems = () => {
  ...
  return useMutation({
    mutationFn: ({ category }) => exportItems(axiosClient, category),
  });
};
