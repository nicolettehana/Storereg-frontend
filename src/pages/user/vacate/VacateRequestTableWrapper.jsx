...
const VacateRequestTableWrapper = ({ query, pageNumber, setPageNumber }) => {
  // Error State
  if (query.isError) {
    return (
      <Center py={16}>
      ...
      <Center py={16}>
        <VStack spacing={4}>
          ...
          <VStack>
            ...
            <Text color="body" textAlign="center">
              It seems you haven't got any vacate request yet.
            </Text>
          </VStack>
        </VStack>
      </Center>
...
export default VacateRequestTableWrapper;
