...
const CHPendingApplicationTableWrapper = ({
  query,
  pageNumber,
  setPageNumber,
  pageSize,
    ...
    return (
      <Center py={16}>
        <VStack spacing={4}>
          ...
          <VStack>
            <Heading size="md">No Pending Applications</Heading>
            <Text color="body" textAlign="center">
              It seems you haven't got any pending quarter booking applications
              yet.
            </Text>
          </VStack>
        </VStack>
...
export default CHPendingApplicationTableWrapper;
