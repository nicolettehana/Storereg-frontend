...
import CreatePurchaseOrderNSModal from "./CreatePurchaseOrderNSModal";

const PurchaseOrderNSTableWrapper = ({
  isEstate = true,
  query,
  searchText,
  pageNumber,
                    ...
                    >
                      {row?.items?.map((item, i) => {
                        const isFirstOccurrence =
                          i === 0 ||
                          row.items[i - 1]?.category !== item.category;

                        return (
                          <Box key={i} mb={1} minH="24px">
                            {isFirstOccurrence ? (
                              <Badge
...
export default PurchaseOrderNSTableWrapper;
