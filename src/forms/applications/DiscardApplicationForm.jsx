...
const DiscardApplicationForm = ({ rowState, actionCode, isOpen, onClose }) => {
  // Hooks
    ...
    (error) => {
      toast({
        ...
        description:
          ...
          "Oops! something went wrong. Couldn't discard application.",
      });
      return error;
    }
  );
              ...
              return (
                <Form>
                  <ModalBody as={Stack} spacing={4}>
                    <Text>
                      Are you sure you want to discard booking application
...
export default DiscardApplicationForm;
