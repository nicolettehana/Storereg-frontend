...
const ReUploadApplicationForm = ({ rowState, actionCode, isOpen, onClose }) => {
  // Hooks
    ...
    (error) => {
      toast({
        ...
        description:
          ...
          "Oops! something went wrong. Couldn't notify applicant to re-upload application.",
      });
      return error;
    }
  );
              ...
              return (
                <Form>
                  <ModalBody as={Stack} spacing={4}>
                    <Text>
                      Are you sure you want to notify the applicant to <br />
                      re-upload booking application number{" "}
...
export default ReUploadApplicationForm;
