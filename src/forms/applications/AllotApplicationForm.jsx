...
import {
  ...
  useUploadFinalAllotmentOrderByCS,
} from "../../hooks/waitingListQueries";
import InputField from "../../components/core/formik/InputField";
import { MdOutlineFileUpload } from "react-icons/md";

const AllotApplicationForm = ({ rowState, actionCode, isOpen, onClose }) => {
  // Hooks
  ...
  const uploadAllotmentOrderQuery = useUploadFinalAllotmentOrderByCS(
    (response) => {
...
export default AllotApplicationForm;
